...
namespace Neo.EasyAccounts.Web.UI.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public ActionResult LinkLogin(string provider)
		{
			...
			return new ChallengeResult(provider, Url.Action("LinkLoginCallback", "Account"), User.Identity.GetUserId<long>());
		}
		...
		{
			public ChallengeResult(string provider, string redirectUri) : this(provider, redirectUri, 0)
			{
			}
