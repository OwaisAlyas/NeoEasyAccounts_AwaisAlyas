...
{
	public class LineOfBusinessMapping : EntityTypeConfiguration<LineOfBusiness>, IMapper
	{
		public LineOfBusinessMapping()
		{
			Property(d => d.Name).IsRequired().HasMaxLength(250);
			Property(d => d.Code).IsRequired().HasMaxLength(250);
			Property(d => d.ManagerName).IsRequired().HasMaxLength(250);
